...
const projects = [
  { id: 1, titleEs: "RoadWarnings Nariño", titleEn: "RoadWarnings Nariño", category: "Aplicación Web / Web App",
  ...
  { id: 3, titleEs: "App de Voluntariado ONG", titleEn: "NGO Volunteering App", category: "Proyecto Clase / Class Project",
  ...
  { id: 4, titleEs: "Portfolio Personal v1", titleEn: "Personal Portfolio v1", category: "Web Development",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {projects.map((project) => (
            <div key={project.id} className="rounded-xl p-6 border flex flex-col transition-all hover:shadow-lg hover:shadow-[#3B82F6]/20"
              ...
              <p className="text-xs uppercase tracking-wider mb-3" style={{ color: "var(--text-secondary)" }}>{project.category}</p>
