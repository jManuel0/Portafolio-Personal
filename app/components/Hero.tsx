        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative">
              <div className="border-4 border-[#3B82F6] rounded-lg bg-gradient-to-br from-[#1E3A8A] to-[#0F172A] overflow-hidden shadow-2xl shadow-[#3B82F6]/20" style={{ position: "relative", width: 400, height: 533 }}>
